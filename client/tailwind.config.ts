  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        cell: {
          editing: "hsl(var(--cell-editing))",
          protected: "hsl(var(--cell-protected))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { 
            boxShadow: "0 0 0 0 hsl(var(--status-connected) / 0.7)",
            opacity: "1"
          },
          "50%": { 
            boxShadow: "0 0 0 8px hsl(var(--status-connected) / 0)",
            opacity: "0.8"
          },
        },
        "spin-slow": {
